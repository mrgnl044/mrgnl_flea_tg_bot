"""
Обработчики команды /start для телеграм-бота объявлений marginal_bot.
"""
...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        ...
        "Добро пожаловать в <b>marginal_bot</b> – эксклюзивную галерею, где любая велотематика обретает ценность: будь то целый велосипед, редкая запчасть или тот странный аксессуар, чье предназначение вы уже забыли.\n"
